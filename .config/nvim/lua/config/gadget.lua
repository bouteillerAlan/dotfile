-- Add an explicit type to the TypeScript `const` under the cursor.
-- Tree-sitter handles unambiguous literals locally; the TypeScript LSP is used
-- only when the expression needs real type inference.
local M = {}
